...
caffe_dist.tar: caffe/distribute/bin/caffe.bin
	tar -cf caffe_dist.tar caffe/distribute
...
# CMake Method
# Here be Dragons.
# By dragons, I mean broken compiles.
...
CMAKE_FLAGS+=-DCMAKE_CXX_COMPILER=$(shell which clang-cpp-8)
